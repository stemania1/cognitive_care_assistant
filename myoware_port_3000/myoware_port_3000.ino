/*
 * MyoWare 2.0 Port 3000 Client
 * 
 * Sends data directly to Next.js app on port 3000
 * 
...
// Server Configuration - Next.js app on port 3000
const char* server_host = "192.168.254.204";  // Your computer's IP
const int server_port = 3000;  // Next.js app port
...
void setup() {
  ...
  Serial.println("MyoWare 2.0 Port 3000 Client");
  Serial.println("============================");
...
void sendEMGData() {
  ...
  // Send HTTP POST request to Next.js app
...
void sendTestData() {
  Serial.println("Sending test data to Next.js app...");
...
void calibrateSensor() {
  ...
  // Send calibration data to Next.js app
