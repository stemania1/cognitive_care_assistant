...
type RemindersState = Record<ReminderKey, boolean>;
...
function LinkCard({ href, title, description, accent }: { href: string; title: string; description: string; accent: string }) {
  return (
...
function RemindersCard() {
  ...
  const [state, setState] = useState<RemindersState>({ drinkWater: false, takeMedicine: false, eatFood: false });
  const [saved, setSaved] = useState(false);
