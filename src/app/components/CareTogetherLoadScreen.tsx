 ...
 * Runs on every full page load (including refresh). Client-side navigations keep the root layout mounted, so the intro does not replay until the next reload.
 */
