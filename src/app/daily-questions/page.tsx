          ...
          <div className="mx-auto max-w-3xl">
            <div className="mb-4 flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <span className="text-xs opacity-70">Set label: Questions {((windowStart % ALL_QUESTIONS.length) + 1)}–{(((windowStart + todaysQuestions.length - 1) % ALL_QUESTIONS.length) + 1)} of {ALL_QUESTIONS.length}</span>
              </div>
